...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, userAvatar, userName }) => {
  const navItems = [
    ...
    { id: 'live', label: 'Broadcast', icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', isLive: true },
    { id: 'resources', label: 'Recursos', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    ...
    { id: 'profile', label: 'Perfil & Estilo', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  ];
    ...
    <div className="w-64 bg-[#0a121e] border-r border-slate-800 flex flex-col h-screen fixed left-0 top-0 z-50">
      <div className="p-8">
        <div className="flex items-center gap-3 mb-12">
          <div className="bg-[#d4af37] p-2 rounded-lg shadow-[0_0_15px_rgba(212,175,55,0.3)]">
      ...
      <div className="mt-auto p-6 border-t border-slate-800">
        <button 
          ...
          className={`w-full bg-[#1e293b]/30 p-4 rounded-xl transition-all hover:bg-slate-800/50 text-left border ${activeTab === 'profile' ? 'border-[#d4af37]/50 shadow-lg' : 'border-transparent'}`}
        >
          <p className="text-[10px] text-slate-500 uppercase tracking-widest mb-2">Membro Premium</p>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center overflow-hidden border border-[#d4af37]/30">
               <img src={userAvatar || "https://i.pravatar.cc/150?u=jane"} alt="User" className="w-full h-full object-cover" />
            </div>
            <div className="truncate">
              <p className="text-sm font-semibold truncate">{userName || 'Ricardo Ginga'}</p>
